    ...
    <section class="sobre">
      <div class="interface">
        <div class="flex">
          ...
          <div class="txt-sobre">
            <h2>MUITO PRAZER, <span>SOMOS A DISBUSSINES</span></h2>
...
<section class="portifolio">
  <div class="interface">
    <h2 class="titulo">CONHEÇA ÁS <span>MICROEMPRESAS.</span></h2>
    <div class="flex">
      <div class="img-port" style="background-image: url(./Imagens/teste2.jpg);">
      <div class="overlay">UBER</div>
    </div>
      <div class="img-port" style="background-image: url(./Imagens/teste2.jpg);">
        <div class="overlay">IFOOD</div>
    </div>
      <div class="img-port" style="background-image: url(./Imagens/teste2.jpg);">
      <div class="overlay">SHEIN</div>
    </div>
  </div>
  </div>
  <div class="interface">
    <div class="flex">
      <div class="img-port" style="background-image: url(./Imagens/teste2.jpg);">
      <div class="overlay">ANCHIETA</div>
    </div>
      <div class="img-port" style="background-image: url(./Imagens/teste2.jpg);">
        <div class="overlay">NUBANK</div>
    </div>
      <div class="img-port" style="background-image: url(./Imagens/teste2.jpg);">
      <div class="overlay">UCB</div>
    </div>
  </div>
  </div>
